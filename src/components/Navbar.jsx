      ...
      >
        ...
        <div>
          <button
            ...
            className="bg-green-700 px-6 py-2 rounded-full hover:bg-green-800 transition"
          >
            Log in
          </button>
        </div>
            ...
            {showSignUp ? (
              ...
              <form className="flex flex-col items-center">
                ...
                <input
                  ...
                  className="bg-transparent border-b-2 text-white w-full h-12 mt-3 outline-none"
                />
                <button className="rounded-full w-28 h-10 mt-4 bg-white text-black">
                  Log in
                </button>
